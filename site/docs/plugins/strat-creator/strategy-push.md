...
<div class="skill-contract">
  ...
  <p class="skill-contract__lede">Push an improved strategy back to Jira and resubmit it to CI for re-evaluation.</p>
  <section class="skill-contract__section" data-section="01">
    ...
    <div class="skill-contract__row">
      ...
      <ul class="skill-contract__list">
        <li>Updates the Jira issue description with refined strategy content.</li>
        <li>Removes needs-attention label and resubmits for CI processing.</li>
      </ul>
    </div>
  </section>
  ...
  <section class="skill-contract__section" data-section="03">
    ...
    <div class="skill-contract__row">
      ...
      <ul class="skill-contract__list">
        <li>Only push strategies with strat-creator-needs-attention label.</li>
        <li>Do not push strategies that have not been locally modified.</li>
      </ul>
    </div>
    <div class="skill-contract__row">
      <span class="skill-contract__field">Fixed Context</span>
      <div class="skill-contract__code">
      <div class="skill-contract__code-line"><span class="skill-contract__code-key">tools</span><span class="skill-contract__code-val">Read, Write, Edit, Bash, Glob, Grep</span></div>
  ...
  <section class="skill-contract__section" data-section="04">
    ...
    <div class="skill-contract__row">
      ...
      <div class="skill-contract__inline"><a class="skill-contract__path" href="https://github.com/opendatahub-io/strat-creator/blob/main/.claude/skills/strategy-push/SKILL.md"><span class="skill-contract__ref-arrow" aria-hidden="true">↗</span><code>.claude/skills/strategy-push/SKILL.md</code></a></div>
    </div>
  </section>
</div>
