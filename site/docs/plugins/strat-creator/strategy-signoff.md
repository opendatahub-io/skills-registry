...
<div class="skill-contract">
  ...
  <p class="skill-contract__lede">Sign off on a CI-approved strategy by pushing final content and adding the human-sign-off label.</p>
  <section class="skill-contract__section" data-section="01">
    ...
    <div class="skill-contract__row">
      ...
      <ul class="skill-contract__list">
        <li>Adds strat-creator-human-sign-off label to the Jira issue.</li>
        <li>Confirms the strategy has passed CI rubric before sign-off.</li>
      </ul>
    </div>
  </section>
  ...
  <section class="skill-contract__section" data-section="04">
    ...
    <div class="skill-contract__row">
      ...
      <div class="skill-contract__inline"><a class="skill-contract__path" href="https://github.com/opendatahub-io/strat-creator/blob/main/.claude/skills/strategy-signoff/SKILL.md"><span class="skill-contract__ref-arrow" aria-hidden="true">↗</span><code>.claude/skills/strategy-signoff/SKILL.md</code></a></div>
    </div>
  </section>
</div>
