...
<div class="skill-contract">
  ...
  <p class="skill-contract__lede">Review strategy features for testability — measurable acceptance criteria, edge case coverage, and validation feasibility.</p>
  <section class="skill-contract__section" data-section="01">
    ...
    <div class="skill-contract__row">
      ...
      <ul class="skill-contract__list">
        <li>Produces a testability assessment for each strategy with recommendation.</li>
        <li>Identifies untestable criteria and missing edge cases.</li>
      </ul>
    </div>
  </section>
  ...
  <section class="skill-contract__section" data-section="03">
    ...
    <div class="skill-contract__row">
      ...
      <ul class="skill-contract__list">
        <li>Do not approve strategies with unmeasurable acceptance criteria.</li>
        <li>Do not invent test scenarios unsupported by the strategy content.</li>
      </ul>
    </div>
    <div class="skill-contract__row">
  ...
  <section class="skill-contract__section" data-section="04">
    ...
    <div class="skill-contract__row">
      ...
      <div class="skill-contract__inline"><a class="skill-contract__path" href="https://github.com/opendatahub-io/strat-creator/blob/main/.claude/skills/strategy-testability-review/SKILL.md"><span class="skill-contract__ref-arrow" aria-hidden="true">↗</span><code>.claude/skills/strategy-testability-review/SKILL.md</code></a></div>
    </div>
  </section>
</div>
