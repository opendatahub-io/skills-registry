...
Create a concise 2-3 line executive summary of a package onboarding outcome
...
<div class="skill-contract">
  ...
  <p class="skill-contract__lede">Summarize the package onboarding outcome into 2-3 lines of plain prose covering build result, root cause of failure, and key next step.</p>
  <section class="skill-contract__section" data-section="01">
    ...
    <div class="skill-contract__row">
      ...
      <ul class="skill-contract__list">
        <li>Produces .executive-summary-output.txt with a 2-3 line summary.</li>
      </ul>
    </div>
  </section>
