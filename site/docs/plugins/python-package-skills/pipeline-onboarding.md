...
Onboard a Python package into the RHAI pipeline onboarding collection across all variants with git commit
...
<div class="skill-contract">
  ...
  <p class="skill-contract__lede">Add a Python package to the onboarding collection for all variants in the pipeline repository, creating requirements files with correct version pinning and tracking comments.</p>
  <section class="skill-contract__section" data-section="01">
    ...
    <div class="skill-contract__row">
      ...
      <ul class="skill-contract__list">
        <li>Requirements files created for all variant directories under collections/onboarding/.</li>
