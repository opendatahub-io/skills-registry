...
<div class="skill-contract">
  ...
  <section class="skill-contract__section" data-section="01">
    ...
    <div class="skill-contract__row">
      ...
      <ul class="skill-contract__list">
        <li>The report never references a value (like the console URL) before it has actually been fetched.</li>
        <li>Truncated output (e.g. tailed warning events) always states the total count alongside the sample shown.</li>
      </ul>
    </div>
  </section>
  <section class="skill-contract__section" data-section="02">
    ...
    <div class="skill-contract__metrics">
      <div class="skill-contract__metric">
        ...
        <a class="skill-contract__ref" href="https://github.com/sheltoncyril/sheltons-toolkit/blob/cec313e2f38d493acf8c8ad65bddb110903fb70a/skills/verify-install/SKILL.md" title="sheltoncyril/sheltons-toolkit@cec313e2f38d493acf8c8ad65bddb110903fb70a:skills/verify-install/SKILL.md">SKILL.md @ cec313e<span class="skill-contract__ref-arrow" aria-hidden="true">&#x2192;</span></a>
      </div>
    </div>
  </section>
  ...
  <section class="skill-contract__section" data-section="04">
    ...
    <div class="skill-contract__row">
      ...
      <div class="skill-contract__inline"><a class="skill-contract__path" href="https://github.com/sheltoncyril/sheltons-toolkit/blob/cec313e2f38d493acf8c8ad65bddb110903fb70a/skills/verify-install/SKILL.md"><span class="skill-contract__ref-arrow" aria-hidden="true">&#x2197;</span><code>skills/verify-install/SKILL.md</code></a></div>
    </div>
  </section>
</div>
