...
-   **[rfe-creator](plugins/rfe-creator/index.md)**
    ...
    Claude Code skills for creating, reviewing, splitting and submitting work items — RFEs to the RHAIRFE Jira project an...

    **13 skills** - Product Planning - v0.1.0
...
-   **[assess-strat](plugins/assess-strat/index.md)**
    ...
    Assess RHAISTRAT strategies against quality criteria using a scored rubric with calibration examples. Scores across f...
